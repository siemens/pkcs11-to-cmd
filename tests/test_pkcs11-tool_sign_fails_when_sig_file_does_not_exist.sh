...
export P2C_SIG="$TEST_WORK_DIR/does-not-exist-after-cmd-call.sig"
...
expect_failed_with "$output" "Failed to open $TEST_WORK_DIR/does-not-exist-after-cmd-call.sig for reading"
